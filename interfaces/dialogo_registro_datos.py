...
class Ui_DialogoRegistroDatos(object):
    def setupUi(self, DialogoRegistroDatos):
        ...
        self.select_nivel_instruccion.addItem(_fromUtf8(""))
        self.select_nivel_instruccion.addItem(_fromUtf8(""))
        self.select_nivel_instruccion.addItem(_fromUtf8(""))
        self.select_nivel_instruccion.addItem(_fromUtf8(""))
    ...
    def retranslateUi(self, DialogoRegistroDatos):
        ...
        self.select_nivel_instruccion.setItemText(0, _translate("DialogoRegistroDatos", "Educación Preescolar", None))
        self.select_nivel_instruccion.setItemText(1, _translate("DialogoRegistroDatos", "Educación Básica", None))
        self.select_nivel_instruccion.setItemText(2, _translate("DialogoRegistroDatos", "Educación Media Diversificada y Profesional", None))
        self.select_nivel_instruccion.setItemText(3, _translate("DialogoRegistroDatos", "Educación Superior", None))
